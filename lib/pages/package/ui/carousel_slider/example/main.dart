...
// class CarouselSliderExamplePage extends StatelessWidget {
//   @override
...
class CarouselSliderExamplePage extends StatelessWidget {
  final _routes = {
    '/basic': BasicDemo(),
    '/nocenter': NoCenterDemo(),
    '/image': ImageSliderDemo(),
    '/complicated': ComplicatedImageDemo(),
    '/enlarge': EnlargeStrategyDemo(),
    '/manual': ManuallyControlledSlider(),
    '/noloop': NoonLoopingDemo(),
    '/vertical': VerticalSliderDemo(),
    '/fullscreen': FullscreenSliderDemo(),
    '/ondemand': OnDemandCarouselDemo(),
    '/indicator': CarouselWithIndicatorDemo(),
    '/prefetch': PrefetchImageDemo(),
    '/reason': CarouselChangeReasonDemo(),
    '/position': KeepPageviewPositionDemo(),
    '/multiple': MultipleItemDemo(),
  };
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          DemoItem('Basic demo', '/basic', _routes),
          DemoItem('No center mode demo', '/nocenter', _routes),
          DemoItem('Image carousel slider', '/image', _routes),
          DemoItem('More complicated image slider', '/complicated', _routes),
          DemoItem('Enlarge strategy demo slider', '/enlarge', _routes),
          DemoItem('Manually controlled slider', '/manual', _routes),
          DemoItem('Noon-looping carousel slider', '/noloop', _routes),
          DemoItem('Vertical carousel slider', '/vertical', _routes),
          DemoItem('Fullscreen carousel slider', '/fullscreen', _routes),
          DemoItem(
              'Carousel with indicator controller demo', '/indicator', _routes),
          DemoItem('On-demand carousel slider', '/ondemand', _routes),
          DemoItem(
              'Image carousel slider with prefetch demo', '/prefetch', _routes),
          DemoItem('Carousel change reason demo', '/reason', _routes),
          DemoItem('Keep pageview position demo', '/position', _routes),
          DemoItem('Multiple item in one screen demo', '/multiple', _routes),
        ],
      ),
    );
  }
...
class DemoItem extends StatelessWidget {
  ...
  final String route;
  final Map routes;
  DemoItem(this.title, this.route, this.routes);
