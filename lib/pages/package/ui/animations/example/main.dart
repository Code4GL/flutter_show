...
class AnimationsExamplePage extends StatefulWidget {
  @override
  AnimationsExamplePageState createState() => AnimationsExamplePageState();
}

class AnimationsExamplePageState extends State<AnimationsExamplePage> {
