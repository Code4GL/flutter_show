...
class VideoPlayerExamplePage extends StatelessWidget {
  @override
            ...
            children: <Widget>[
              ...
              Stack(
                  ...
                  children: <Widget>[
                    _ButterFlyAssetVideo(),
                    Image.asset(
                        'assets/images/package/video_player/flutter-mark-square-64.png'),
                  ]),
            ],
          ),
        ])),
...
class _BumbleBeeRemoteVideoState extends State<_BumbleBeeRemoteVideo> {
  ...
  Future<ClosedCaptionFile> _loadCaptions() async {
    final String fileContents = await DefaultAssetBundle.of(context).loadString(
        'assets/images/package/video_player/bumble_bee_captions.srt');
